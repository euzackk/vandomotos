...
export function renderContratos(container) {
            ...
            <div class="bg-white border border-gray-900 w-full max-w-4xl shadow-2xl overflow-hidden transform scale-95 transition-transform flex flex-col" id="modal-contrato-panel">
                ...
                <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center bg-gray-50">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 font-mono mt-0.5">Cruzamento de dados do Cliente e Património</p>
                    </div>
                ...
                <form id="form-contrato" class="p-6 space-y-6 bg-white overflow-y-auto max-h-[70vh] custom-scroll">
                    ...
                    <div class="bg-brand-light border border-brand-main p-4 flex flex-col md:flex-row gap-4 mb-2">
                        ...
                        <div class="flex-1">
                            <label class="block text-xs font-extrabold text-brand-hover uppercase tracking-wider mb-1"><i class="ph-fill ph-motorcycle"></i> Património Disponível no Pátio *</label>
    ...
    // ------------------------------------------------------------------------
    // RENDERIZAÇÃO E CRUZAMENTO DE DADOS
    // ------------------------------------------------------------------------
    
    function carregarSelects() {
        selCliente.innerHTML = '<option value="">-- Indique o Cliente --</option>';
        selVeiculo.innerHTML = '<option value="">-- Mota Livre no Pátio --</option>';
        ...
        // Carrega APENAS Motas Disponíveis (A trava de segurança começa aqui)
    ...
    function atualizarTabela() {
        ...
        // Ordenar: Ativos no topo, mais recentes primeiro
        filtrados.sort((a, b) => {
    ...
    // ------------------------------------------------------------------------
    // MOTOR DE GERAÇÃO DE PDF (DOCUMENTO JURÍDICO)
    // ------------------------------------------------------------------------
    function gerarPDFContrato(contratoId) {
        ...
        // Tratamento de Dados para o Documento
        ...
        // Criação de uma janela limpa para impressão nativa do navegador
        ...
        const html = \`
            ...
            <body>
                ...
                <ul>
                    ...
                    <li><span class="bold">Vistoria Inicial:</span> Veículo entregue com <span class="bold">\${combustivelSaida} traço(s) de combustível</span>, higienizado e conforme registo fotográfico em anexo no sistema.</li>
                </ul>
        ...
        // Aguarda renderização do navegador antes de chamar o pop-up de impressão
        setTimeout(() => {
            janelaPDF.print();
        }, 800);
    }
    ...
    function toggleModal(abrir = true) {
        if (abrir) {
            ...
            // Auto-preenche a data de saída para o minuto atual
    ...
    form.addEventListener('submit', (e) => {
        ...
        const novoContrato = {
            ...
            tracos_saida: veiculoObj ? (veiculoObj.combustivel || 0) : 0, // Regista a gasolina do momento exato
            status: 'ativo'
        };
        ...
        // 2. Trava o Veículo na Oficina/Módulo de Frota
        if (veiculoObj) {
            veiculoObj.status = 'locado';
        }

        // 3. (Opcional) Lança Caução no Caixa se desejar integração com o módulo Financeiro
        // ...
        ...
        // 4. Pergunta imediatamente se o utilizador deseja imprimir o PDF
    ...
    // Ações na Tabela (Imprimir e Encerrar)
    tbody.addEventListener('click', (e) => {
        ...
        if (btnEncerrar) {
            ...
            if (confirm("Confirma a receção do veículo e o encerramento da locação? O veículo voltará a ficar 'Disponível' no pátio para novos contratos.")) {
                ...
                // Liberta a mota no Módulo de Veículos
